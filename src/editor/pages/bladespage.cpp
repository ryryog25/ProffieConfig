...
BladesPage::BladesPage(wxWindow* _parent) : wxPanel(_parent, wxID_ANY), parent{static_cast<EditorWindow*>(_parent)} {
    bladeArrayDlg = new BladeArrayDlg(parent);
    sizer = new wxStaticBoxSizer(wxHORIZONTAL, this);
    SetSizer(sizer);

    sizer->Add(createBladeSelect(), wxSizerFlags(0).Expand());
    sizer->Add(createBladeSetup(), wxSizerFlags(1).Expand());
    sizer->Add(createBladeSettings(), wxSizerFlags(0).ReserveSpaceEvenIfHidden());
...
void BladesPage::bindEvents() {
    Bind(wxEVT_BUTTON, [&](wxCommandEvent&) { if (bladeArrayDlg->IsShown()) bladeArrayDlg->Raise(); else bladeArrayDlg->Show(); }, ID_OpenBladeArrays);

    Bind(wxEVT_COMBOBOX, [&](wxCommandEvent&) { parent->presetsPage->bladeArray->entry()->SetSelection(bladeArray->entry()->GetSelection()); update(); }, ID_BladeArray);
    Bind(wxEVT_SPINCTRL, [&](wxCommandEvent& event) { update(); event.Skip(); });
    Bind(wxEVT_RADIOBUTTON, [&](wxCommandEvent& event) { update(); FULLUPDATEWINDOW(parent); event.Skip(); });
    Bind(wxEVT_LISTBOX, [&](wxCommandEvent&) { update(); FULLUPDATEWINDOW(parent); }, ID_BladeSelect);
    Bind(wxEVT_LISTBOX, [&](wxCommandEvent&) { update(); FULLUPDATEWINDOW(parent); }, ID_SubBladeSelect);
    Bind(wxEVT_COMBOBOX, [&](wxCommandEvent&) { update(); FULLUPDATEWINDOW(parent); }, ID_BladeType);
    Bind(wxEVT_BUTTON, [&](wxCommandEvent&) { addBlade(); UPDATEWINDOW(parent); }, ID_AddBlade);
    Bind(wxEVT_BUTTON, [&](wxCommandEvent&) { addSubBlade(); FULLUPDATEWINDOW(parent); }, ID_AddSubBlade);
    Bind(wxEVT_BUTTON, [&](wxCommandEvent&) { removeBlade(); UPDATEWINDOW(parent); }, ID_RemoveBlade);
    Bind(wxEVT_BUTTON, [&](wxCommandEvent&) { removeSubBlade(); UPDATEWINDOW(parent); }, ID_RemoveSubBlade);
    ...
    Bind(wxEVT_CHECKLISTBOX, [&](wxCommandEvent&) {
            update();
...
wxBoxSizer* BladesPage::createBladeSelect() {
    ...
    bladeArray = new pcComboBox(this, ID_BladeArray, "Blade Array", wxDefaultPosition, wxDefaultSize, Misc::createEntries({ "blade_in" }), wxCB_READONLY);
    bladeArrayButton = new wxButton(this, ID_OpenBladeArrays, "Blade Awareness...");
...
wxBoxSizer* BladesPage::createBladeManager() {
    ...
    wxStaticText* bladeText = new wxStaticText(this, wxID_ANY, "Blades");
    bladeSelect = new wxListBox(this, ID_BladeSelect);
    wxBoxSizer* bladeButtons = new wxBoxSizer(wxHORIZONTAL);
    addBladeButton = new wxButton(this, ID_AddBlade, "+", wxDefaultPosition, SMALLBUTTONSIZE, wxBU_EXACTFIT);
    removeBladeButton = new wxButton(this, ID_RemoveBlade, "-", wxDefaultPosition, SMALLBUTTONSIZE, wxBU_EXACTFIT);
    ...
    wxStaticText* subBladeText = new wxStaticText(this, wxID_ANY, "SubBlades");
    subBladeSelect = new wxListBox(this, ID_SubBladeSelect, wxDefaultPosition, wxSize(100, -1));
    wxBoxSizer* subBladeButtonSizer = new wxBoxSizer(wxHORIZONTAL);
    addSubBladeButton = new wxButton(this, ID_AddSubBlade, "+", wxDefaultPosition, SMALLBUTTONSIZE, wxBU_EXACTFIT);
    removeSubBladeButton = new wxButton(this, ID_RemoveSubBlade, "-", wxDefaultPosition, SMALLBUTTONSIZE, wxBU_EXACTFIT);
...
wxBoxSizer* BladesPage::createBladeSetup() {
    ...
    bladeType = new pcComboBox(this, ID_BladeType, "Blade Type", wxDefaultPosition, wxDefaultSize, Misc::createEntries({BD_PIXELRGB, BD_PIXELRGBW, BD_TRISTAR, BD_QUADSTAR, BD_SINGLELED}), wxCB_READONLY);
    powerPins = new wxCheckListBox(this, ID_PowerPins, wxDefaultPosition, wxSize(200, -1), Misc::createEntries({"bladePowerPin1", "bladePowerPin2", "bladePowerPin3", "bladePowerPin4", "bladePowerPin5", "bladePowerPin6"}));
    auto pinNameSizer = new wxBoxSizer(wxHORIZONTAL);
    addPowerPin = new wxButton(this, ID_AddPowerPin, "+", wxDefaultPosition, wxSize(30, 20), wxBU_EXACTFIT);
    powerPinName = new pcTextCtrl(this, ID_PowerPinName, "Pin Name");
...
wxBoxSizer* BladesPage::createBladeSettings() {
    ...
    blade3ColorOrder = new pcComboBox(this, wxID_ANY, "Color Order", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"BGR", "BRG", "GBR", "GRB", "RBG", "RGB"}), wxCB_READONLY);
    blade4ColorOrder = new pcComboBox(this, wxID_ANY, "Color Order", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"BGRW", "BRGW", "GBRW", "GRBW", "RBGW", "RGBW", "WBGR", "WBRG", "WGBR", "WGRB", "WRBG", "WRGB"}), wxCB_READONLY);
    ...
    blade4UseRGB = new wxCheckBox(this, wxID_ANY, "Use RGB with White");
    bladeDataPin = new pcComboBox(this, wxID_ANY, "Blade Data Pin", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"bladePin", "blade2Pin", "blade3Pin", "blade4Pin"}));
    bladePixelsLabel = new wxStaticText(this, wxID_ANY, "Number of Pixels");
    bladePixels = new pcSpinCtrl(this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, 0, 144, 0);

    wxBoxSizer* star1 = new wxBoxSizer(wxVERTICAL);
    star1Color = new pcComboBox(this, wxID_ANY, "LED 1 Color", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"Red", "Green", "Blue", "Amber", "RedOrange", "White", BD_NORESISTANCE}), wxCB_READONLY);
    star1Resistance = new pcSpinCtrl(this, wxID_ANY, "Resistance", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10000, 500);
    ...
    star2Color = new pcComboBox(this, wxID_ANY, "LED 2 Color", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"Red", "Green", "Blue", "Amber", "RedOrange", "White", BD_NORESISTANCE}), wxCB_READONLY);
    star2Resistance = new pcSpinCtrl(this, wxID_ANY, "Resistance", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10000, 500);
    ...
    star3Color = new pcComboBox(this, wxID_ANY, "LED 3 Color", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"Red", "Green", "Blue", "Amber", "RedOrange", "White", BD_NORESISTANCE}), wxCB_READONLY);
    star3Resistance = new pcSpinCtrl(this, wxID_ANY, "Resistance", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10000, 500);
    ...
    star4Color = new pcComboBox(this, wxID_ANY, "LED 4 Color", wxDefaultPosition, wxDefaultSize, Misc::createEntries({"Red", "Green", "Blue", "Amber", "RedOrange", "White", BD_NORESISTANCE}), wxCB_READONLY);
    star4Resistance = new pcSpinCtrl(this, wxID_ANY, "Resistance", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10000, 500);
    star4->Add(star4Color, MENUITEMFLAGS);
    star4->Add(star4Resistance, MENUITEMFLAGS.TripleBorder(wxLEFT).Expand());

    useStandard = new wxRadioButton(this, wxID_ANY, "Standard SubBlade", wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
    useStride   = new wxRadioButton(this, wxID_ANY, "Stride SubBlade");
    useZigZag   = new wxRadioButton(this, wxID_ANY, "ZigZag SubBlade");
    subBladeStart = new pcSpinCtrl(this, wxID_ANY, "SubBlade Start", wxDefaultPosition, wxDefaultSize, 0, 0, 144, 0);
    subBladeEnd   = new pcSpinCtrl(this, wxID_ANY, "SubBlade End", wxDefaultPosition, wxDefaultSize, 0, 0, 144, 0);
