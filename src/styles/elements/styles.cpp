...
#define STYLE(name, humanName, ...) GENERATORMAP(name, humanName, COLOR, __VA_ARGS__)
#define LAYER(name, humanName, ...) GENERATORMAP(name, humanName, COLOR | TRANSPARENT, __VA_ARGS__)

const BladeStyles::Generator::StyleMap& BladeStyles::Style::getMap() {
    static Generator::StyleMap map{
        ...
        // very configurable.
        LAYER("OriginalBlastL", "Original Blast",
              Arg("Blast Color", COLOR),
              Arg("Trigger Effect", EFFECT, Effect::BLAST)
              ),
        ...
        LAYER("SimpleClashL", "Simple Clash",
              ...
              Arg("Stab Shape", INT | FUNCTION, Generator::get("SmoothStep")({Generator::get("Int")({16384}), Generator::get("Int")({24000})})) // Your guess is as good as mine as to what this does...
              ),
...
const BladeStyles::Generator::StyleGenerator BladeStyles::Style::get(const std::string& styleName) {
