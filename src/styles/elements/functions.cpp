...
#define FUNC(name, humanName, ...) GENERATORMAP(name, humanName, INT | FUNCTION, __VA_ARGS__)
#define LAYER(name, humanName, ...) GENERATORMAP(name, humanName, COLOR | TRANSPARENT, __VA_ARGS__)

const BladeStyles::Generator::StyleGenerator BladeStyles::Function::get(const std::string& styleName) {
...
const BladeStyles::Generator::StyleMap& BladeStyles::Function::getMap() {
    static Generator::StyleMap map{
        ...
        FUNC("BladeAngleX", "Blade Angle",
             Arg("Min", INT | FUNCTION, Generator::get("Int")({ 0 })),
             Arg("Max", INT | FUNCTION, Generator::get("Int")({ 32768 }))
             ),
        ...
        FUNC("Bump", "Bump",
             ...
             Arg("Width", INT | FUNCTION, Generator::get("Int")({ 16385 }))
             ),
        ...
        FUNC("CenterDistF", "Center Distribution",
             Arg("Center", INT | FUNCTION, Generator::get("Int")({ 16384 }))
             ),
        ...
        FUNC("IncrementWithReset", "Increment With Reset",
             ...
             Arg("Pulse Reset", 	INT | FUNCTION, Generator::get("Int")({ 0 })),
             Arg("Max", 			INT | FUNCTION, Generator::get("Int")({ 32768 })),
             Arg("Increment", 		INT | FUNCTION, Generator::get("Int")({ 1 }))
             ),
        ...
        FUNC("ThresholdPulseF", "Pulse on Threshold",
             Arg("Input", INT | FUNCTION),
             Arg("Threshold", INT | FUNCTION, Generator::get("Int")({ 32768 })),
             Arg("Hysteresis %", INT | FUNCTION, Generator::get("Int")({ 66 }))
             ),
        ...
        FUNC("IncrementF", "Increment on Input",
             Arg("Input", INT | FUNCTION),
             Arg("Increment Threshold", INT | FUNCTION, Generator::get("Int")({ 32768 })),
             Arg("Max Value", INT | FUNCTION, Generator::get("Int")({ 32768 })),
             Arg("Increment", INT | FUNCTION, Generator::get("Int")({ 1 })),
             Arg("Hysteresis %", INT | FUNCTION, Generator::get("Int")({ 66 }))
             ),
